  ...
  <div class="inspection-container">
    <el-card class="header-card">
      <div class="header-title">
        <h2>查看检验申请</h2>
        <span class="subtitle">所有检验类(LAB)医技申请单</span>
      </div>
    </el-card>
    ...
    <!-- 详情弹窗 -->
    <el-dialog v-model="detailVisible" title="检验申请详情" width="650px">
      <el-descriptions v-if="currentOrder" :column="2" border>
        ...
        <el-descriptions-item label="检验项目">{{ currentOrder.itemName }}</el-descriptions-item>
